...
function [topology, mote_IDs] = test_topo(varargin)
	...
	r = 3;
	mote_IDs = [1, 2, 3, 4, 5];	            % definir los IDs de los nodos
	mote_Xs = [0, r/2, r/2, r, r];	            % ubicaciones respectivas sobre eje X
	mote_Ys = [0, -r/2, r/2, 0, r/2];	% ubicaciones respectivas sobre eje Y
