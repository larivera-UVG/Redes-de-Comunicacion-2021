...
sequenceDiagram
Coordinador--> Nodo: 
Nodo->> Coordinador: Quiero unirme
Coordinador->> Nodo: Confirmación
Note right of Nodo: Espera la información de la red
Coordinador->> Nodo: Información de la PAN
Nodo->> Coordinador: Confirmación
```
...
Coordinador--> Nodo 3: 
Coordinador--> Nodo 4: 
Coordinador-> Nodo 4: Sincronizar 
Nodo 1->> Nodo 2: mensaje
Nodo 2->> Nodo 3: mensaje
Nodo 3->> Nodo 4: mensaje
Nodo 4->> Coordinador: mensaje
```
...
```mermaid
sequenceDiagram
Coordinador->> Nodo 1: Sigue conectado?
Nodo 1->> Coordinador: Si
Coordinador->> Nodo 2: Sigue conectado?
Nodo 2->> Coordinador: Si
Coordinador->> Nodo 3: Sigue conectado?
Nodo 3->> Coordinador: Si
Coordinador->> Nodo 4: Sigue conectado?
Nodo 4--x Coordinador: No hubo respuesta
Note left of Coordinador: Únicamente respondieron<br/> 3 nodos, libera la<br/> dirección del nodo 4.
Coordinador-> Nodo 3: Actualiza la información de la red
```
...
```mermaid
sequenceDiagram
Coordinador--x Nodo 1: Fallo
Coordinador--x Nodo 2: Fallo
Coordinador--x Nodo 3: Fallo
Coordinador--x Nodo 4: Fallo
Nodo 1-> Nodo 4: Nuevo candidato
Nodo 2->> Nodo 1: Voto
Nodo 3->> Nodo 1: Voto
Nodo 4->> Nodo 1: Voto
Note left of Nodo 1: Se obtuvieron los<br/> votos necesarios<br/> para cambiar de<br/> coordinador.
Nodo 1-> Nodo 4: Confirmación de nuevo coordinador
```
